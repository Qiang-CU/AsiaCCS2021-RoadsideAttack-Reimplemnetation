...
# Optional dataset imports — skip gracefully if dependencies are missing
_optional_datasets = [
    ...
    ('.custom.custom_dataset', 'CustomDataset'),
]
for _mod, _cls in _optional_datasets:
    try:
        import importlib as _il
        _m = _il.import_module(_mod, package=__name__)
        __all__[_cls] = getattr(_m, _cls)
